...
class SystemUserService extends AbstractService implements UserServiceInterface
{
     ...
     */
    public function __construct(ContainerInterface $container, SystemUserMapper $mapper, SystemMenuService $systemMenuService, SystemRoleService $systemRoleService)
    {
    ...
    {
        $res = $this->mapper->getModel()::query()->where('id', $params['id'])->update(['dashboard' => $params['dashboard']]) > 0;
