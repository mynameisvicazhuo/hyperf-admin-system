...
class SystemUploadFileMapper extends AbstractMapper
{
    ...
    public function realDelete(array $ids) : bool
    {
        foreach ($ids as $id) {
            ...
            if ($model) {
                ...
                $event = new \Mine\Event\RealDeleteUploadFile($model, $this->container->get(FilesystemFactory::class)->get($storageMode));
    ...
    {
        return $this->model::withTrashed()->where('storage_path', $path)->orWhere('storage_path', 'like', $path . '/%')->exists();
    }
}