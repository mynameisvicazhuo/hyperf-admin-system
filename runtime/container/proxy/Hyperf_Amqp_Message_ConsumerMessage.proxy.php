...
abstract class ConsumerMessage extends Message implements ConsumerMessageInterface
{
    ...
    public function consumeMessage($data, AMQPMessage $message) : string
    {
        ...
        return self::__proxyCall(__CLASS__, __FUNCTION__, self::__getParamsMap(__CLASS__, __FUNCTION__, func_get_args()), function ($data, AMQPMessage $message) use($__function__, $__method__) {
    ...
    protected function reply($data, AMQPMessage $message)
    {
        ...
        $channel->basic_publish(new AMQPMessage($packer->pack($data), ['correlation_id' => $message->get('correlation_id')]), '', $message->get('reply_to'));
    }
}