...
class CoreMiddleware implements CoreMiddlewareInterface
{
    ...
    protected function transferToResponse($response, ServerRequestInterface $request) : ResponseInterface
    {
        ...
        return self::__proxyCall(__CLASS__, __FUNCTION__, self::__getParamsMap(__CLASS__, __FUNCTION__, func_get_args()), function ($response, ServerRequestInterface $request) use($__function__, $__method__) {
    ...
    private function getInjections(array $definitions, string $callableName, array $arguments) : array
    {
        $__function__ = __FUNCTION__;
        $__method__ = __METHOD__;
        return self::__proxyCall(__CLASS__, __FUNCTION__, self::__getParamsMap(__CLASS__, __FUNCTION__, func_get_args()), function (array $definitions, string $callableName, array $arguments) use($__function__, $__method__) {
            $injections = [];
