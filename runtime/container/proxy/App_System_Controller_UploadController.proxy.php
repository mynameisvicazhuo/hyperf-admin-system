...
class UploadController extends MineController
{
    ...
    public function uploadFile(UploadRequest $request) : \Psr\Http\Message\ResponseInterface
    {
        ...
        return self::__proxyCall(__CLASS__, __FUNCTION__, self::__getParamsMap(__CLASS__, __FUNCTION__, func_get_args()), function (UploadRequest $request) use($__function__, $__method__) {
    ...
    public function getAllFile() : \Psr\Http\Message\ResponseInterface
    {
        ...
        return self::__proxyCall(__CLASS__, __FUNCTION__, self::__getParamsMap(__CLASS__, __FUNCTION__, func_get_args()), function () use($__function__, $__method__) {
            return $this->success($this->service->getAllFile($this->request->all()));
        });
    }
    /**
     * 通过ID获取文件信息
