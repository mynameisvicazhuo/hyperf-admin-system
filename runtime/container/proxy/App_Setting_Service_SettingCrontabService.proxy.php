...
class SettingCrontabService extends AbstractService
{
    ...
    public function changeStatus(int $id, string $value, string $filed = 'status') : bool
    {
        ...
        return self::__proxyCall(__CLASS__, __FUNCTION__, self::__getParamsMap(__CLASS__, __FUNCTION__, func_get_args()), function (int $id, string $value, string $filed = 'status') use($__function__, $__method__) {
