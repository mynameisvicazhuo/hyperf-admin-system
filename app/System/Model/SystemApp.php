 ...
 * @property string $components_host component domain
 * @property-read \Hyperf\Database\Model\Collection|SystemApi[]|null $apis 
 * @property-read SystemAppGroup|null $appGroup 
 */
class SystemApp extends MineModel
{
     ...
     * @var array
     */
    protected array $fillable = ['id', 'group_id', 'app_name', 'app_id', 'app_secret', 'status', 'description', 'created_by', 'updated_by', 'created_at', 'updated_at', 'deleted_at', 'remark', 'logo', 'components_host'];
    /**
