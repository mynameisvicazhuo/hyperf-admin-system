...
class CreateSystemAppMenuTable extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('system_app_menu', function (Blueprint $table) {
            $table->engine = 'Innodb';
            $table->comment('菜单信息表');
            $table->bigIncrements('id')->comment('主键');
            $table->addColumn('bigInteger','app_id',['comment' => 'App ID']);
    ...
    {
        Schema::dropIfExists('system_app_menu');
    }
}
